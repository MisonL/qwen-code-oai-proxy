const { anthropicToQwenConverter, qwenToAnthropicConverter } = require('../../src/anthropic/converter.js');
...
describe('Anthropic API Converters', () => {
  describe('anthropicToQwenConverter', () => {
    ...
    it('should handle different Anthropic models', () => {
      ...
      testCases.forEach(({ input, expected }) => {
        const result = anthropicToQwenConverter({ model: input, messages: [], max_tokens: 100 });
  ...
  describe('qwenToAnthropicConverter', () => {
    it('should convert Qwen response to Anthropic format', () => {
      ...
      expect(result.model).toBe('claude-3-5-sonnet-latest'); // Default Anthropic model
